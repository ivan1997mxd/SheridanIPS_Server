...
class svm_model(Structure):
    ...
    def get_labels(self):
        ...
        combs = int(nr_class * (nr_class - 1) / 2)
        margin = (c_double * combs)()
        libsvm.svm_get_labels(self, margin)
        return margin[:combs]
    ...
    def get_predict(self, x):
        return libsvm.svm_predict(self, x)
...
fillprototype(libsvm.svm_get_labels, None, [POINTER(svm_model), POINTER(c_double)])
# fillprototype(libsvm.svm_get_margin, None, [POINTER(svm_model), POINTER(c_double)])
